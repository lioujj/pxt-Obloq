...
namespace Obloq {
    ...
    */
    ...
    function Obloq_start_connect_mqtt_new(address: string, port: number, connectStart: string): void {
        OBLOQ_WORKING_MODE_IS_MQTT = OBLOQ_BOOL_TYPE_IS_TRUE
     ...
     * @param SSID to SSID ,eg: "yourSSID"
     * @param PASSWORD to PASSWORD ,eg: "yourPASSWORD"
     * @param address to address ,eg: "MQTTServer"
     * @param port to port ,eg: 1883
     * @param IOT_ID to IOT_ID ,eg: "yourIotId"
     * @param IOT_PWD to IOT_PWD ,eg: "yourIotPwd"
     * @param IOT_TOPIC to IOT_TOPIC ,eg: "yourIotTopic"
     * @param receive to receive ,eg: SerialPin.P1
    ...
    */
    ...
    /**
     * reset HTTP IP and port
    */
    //% weight=81
    //% blockId=Obloq_http_reset
    //% block="reset http IP %IP| port %PORT"
    //% advanced=false
